...
public class JsonResult<T> implements Serializable {
	 ...
	 * 状态码
	 */
	@ApiModelProperty(value = "状态码", position = 1, example = "200, 400, 401, 403, 404, 409, 500")
	private Integer state;
	/**
	 * 消息
	 */
	@ApiModelProperty(value = "消息", position = 2, example = "投图成功")
	 ...
	 * @return 响应结果对象
	 */
	public static <T> JsonResult<T> failed(ResponseCode responseCode, String message, T data) {
		JsonResult<T> jsonResult = new JsonResult<>();
		jsonResult.setState(responseCode.getValue());
		jsonResult.setMessage(message);
		jsonResult.setData(data);
